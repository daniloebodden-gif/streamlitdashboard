...
with tab4:
    ...
    image_url = "https://apod.nasa.gov/apod/image/2601/NGC-2442-rev-1-crop-18-Jan-2026_2048.jpg"
    response = apod_generator(url,os.getenv("NASA_API_KEY"))

    # TODO: display the APOD image and title the other features
    st.image("https://apod.nasa.gov/apod/image/2601/NGC-2442-rev-1-crop-18-Jan-2026_2048.jpg", width=500)
